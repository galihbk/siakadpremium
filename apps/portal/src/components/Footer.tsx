    ...
    <footer id="kontak" className="bg-[#0F172A] text-slate-300 pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              {/* Instagram */}
              <a href={profile.socialInstagram || '#'} className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#1E3A8A] flex items-center justify-center text-slate-300 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href={profile.socialYoutube || '#'} className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#1E3A8A] flex items-center justify-center text-slate-300 hover:text-white transition-colors" aria-label="YouTube">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              {/* LinkedIn */}
              <a href={profile.socialLinkedin || '#'} className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-[#1E3A8A] flex items-center justify-center text-slate-300 hover:text-white transition-colors" aria-label="LinkedIn">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <div className="p-3.5 bg-slate-800/80 rounded-xl border border-slate-700/80 text-xs">
              ...
              <p className="text-slate-400 mt-0.5">Email: {profile.contactEmail}</p>
            </div>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>
            &copy; {new Date().getFullYear()} {profile.campusName}. Hak Cipta Dilindungi Undang-Undang.
          </p>
